...
<!--<!DOCTYPE html>-->
<!-- saved from url=(0037)http://adnantopal.github.io/slimmenu/ -->
<!--<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">-->
<!--    <title>jQuery slimMenu - A lightweight responsive and multi-level navigation menu plugin.</title>-->
<!--    <meta charset="utf-8">-->
<!--    <meta name="viewport" content="width=device-width, initial-scale=1.0">-->
<!--    <link href="http://netdna.bootstrapcdn.com/bootswatch/2.3.2/spacelab/bootstrap.min.css" rel="stylesheet">-->
<!--    <link href="http://adnantopal.github.io/slimmenu/css/bootstrap-responsive.min.css" rel="stylesheet" media="screen">-->
...
<!--            <ul class="slimmenu">-->
<!--                <li>-->
<!--                    <a href="http://adnantopal.github.io/slimmenu/#">Slim Menu 1</a>-->
<!--                    <ul style="display: none; height: 90px; padding-top: 0px; margin-top: 0px; padding-bottom: 0px; margin-bottom: 0px;">-->
<!--                        <li>-->
<!--                            <a href="http://adnantopal.github.io/slimmenu/#">Slim Menu 1.1</a>-->
<!--                            <ul style="display: none;">-->
<!--                                <li><a href="http://adnantopal.github.io/slimmenu/#">Slim Menu 1.1.1</a></li>-->
<!--                                <li>-->
<!--                                    <a href="http://adnantopal.github.io/slimmenu/#">Slim Menu 1.1.2</a>-->
<!--                                    <ul style="display: none;">-->
<!--                                        <li><a href="http://adnantopal.github.io/slimmenu/#">Slim Menu 1.1.2.1</a></li>-->
<!--                                        <li><a href="http://adnantopal.github.io/slimmenu/#">Slim Menu 1.1.2.2</a></li>-->
<!--                                    </ul>-->
<!--                                <span class="sub-collapser"><i>CC</i></span></li>-->
<!--                            </ul>-->
<!--                        <span class="sub-collapser"><i>CC</i></span></li>-->
<!--                        <li><a href="http://adnantopal.github.io/slimmenu/#">Slim Menu 1.2</a></li>-->
<!--                    </ul>-->
<!--                <span class="sub-collapser"><i>CC</i></span></li>-->
<!--                <li><a href="http://adnantopal.github.io/slimmenu/#">Slim Menu 2</a></li>-->
<!--                <li>-->
<!--                    <a href="http://adnantopal.github.io/slimmenu/#">Slim Menu 3</a>-->
<!--                    <ul style="display: none; height: 90px; padding-top: 0px; margin-top: 0px; padding-bottom: 0px; margin-bottom: 0px;">-->
<!--                        <li>-->
<!--                            <a href="http://adnantopal.github.io/slimmenu/#">Slim Menu 3.1</a>-->
<!--                            <ul style="display: none; height: 90px; padding-top: 0px; margin-top: 0px; padding-bottom: 0px; margin-bottom: 0px;">-->
<!--                                <li><a href="http://adnantopal.github.io/slimmenu/#">Slim Menu 3.1.1</a></li>-->
<!--                                <li><a href="http://adnantopal.github.io/slimmenu/#">Slim Menu 3.1.2</a></li>-->
<!--                            </ul>-->
<!--                        <span class="sub-collapser"><i>CC</i></span></li>-->
<!--                        <li><a href="http://adnantopal.github.io/slimmenu/#">Slim Menu 3.2</a></li>-->
<!--                    </ul>-->
<!--                <span class="sub-collapser"><i>CC</i></span></li>-->
<!--                <li><a href="http://adnantopal.github.io/slimmenu/#">Slim Menu 4</a></li>-->
<!--            </ul>-->
<!--        </div>-->
<!--    </div>-->
<!---->
<!--<script src="./jQuery slimMenu - A lightweight responsive and multi-level navigation menu plugin._files/jquery.min.js"></script>-->
<!--<script src="./jQuery slimMenu - A lightweight responsive and multi-level navigation menu plugin._files/jquery.easing.min.js"></script>-->
<!--<script src="./jQuery slimMenu - A lightweight responsive and multi-level navigation menu plugin._files/bootstrap.min.js"></script>-->
<!--<script src="./jQuery slimMenu - A lightweight responsive and multi-level navigation menu plugin._files/jquery.slimmenu.js"></script>-->
<!--<script>-->
<!--$(function() {-->
