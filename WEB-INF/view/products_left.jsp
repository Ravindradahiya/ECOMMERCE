...
<link href="<c:out value='${pageContext.servletContext.contextPath}'/>/JS/tree_struct/mtree.css" rel="stylesheet" type="text/css">
<style>
.mtree-demo .mtree {
  background: #EEE;
  margin: 20px auto;
...
<script type="text/javascript" src="<c:out value='${pageContext.servletContext.contextPath}'/>/JS/tree_struct/mtree.js"></script>
<script>
